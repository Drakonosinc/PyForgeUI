...
class PressedButton:
    ...
    def pressed_button(self,rect,pressed_mouse,mouse_pos,draw=None,repeat:bool = None):
        def execute(sound = False, active = False, presses = True, time = None):
        ...
        if pressed_mouse[0] and rect.collidepoint(mouse_pos) and self.states["presses_touch"]:execute(False,True,False,current_time)
